            ...
            <div class="flex justify-center fade-in">
              <div class="flex flex-col items-center justify-center gap-6">
                ...
                <div class="flex items-center justify-center gap-2">
                  ...
                  ${profile.links?.researchgate ? `<a href="${escapeHtml(profile.links.researchgate)}" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="ResearchGate"><svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 4.5h6.2a4.3 4.3 0 1 1 0 8.6H8.8V19.5"/><path d="M8.8 13.1h2.4l4.2 6.4"/><path d="M16.8 5.2h2.2M17.9 4.1v2.2"/></svg></a>` : ''}
